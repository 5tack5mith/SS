...
export default function WhosMoreLikely(){
  ...
  const generateQuiz = async () => {
    ...
    try {
      const prompt = "Generate 3 'Who's more likely to' questions for couples. Keep them playful."
    ...
    <div style={bgStyle} className='min-h-screen w-full bg-center bg-cover transition-all duration-500'>
      ...
      <div className='min-h-screen flex items-center justify-center px-6 py-12'>
        <div className='glass-card p-10 rounded-3xl shadow-2xl max-w-4xl w-full'>
          <h1 className='text-4xl font-marker mb-8 text-center'>👀 Who's More Likely</h1>
